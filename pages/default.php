...
<div class="container my-5 d-grid gap-5">
    <div class=" home-coloum p-5 border">
      <div class="clearfix">
        <img src="img/5.jpg" class="col-md-4 float-md-start mb-3 me-md-5" alt="Coffee">
        <p>
    ...
    <div class="home-coloum p-5 border">
      <div class="clearfix">
        <img src="img/4.jpg" class="col-md-4 float-md-end mb-3 ms-md-5" alt="biscuits">
        <p>
          A paragraph of placeholder text. We're using it here to show the use of the clearfix class. We're adding quite a few meaningless phrases here to demonstrate how the columns interact here with the floated image.
        </p>
        <p>
...
<section class="py-7 py-md-9 border-bottom">
  ...
  <div class="nav justify-content-center mb-6" id="menuTabs" role="tablist">
    <a class="nav-link active" id="mainsTab" data-bs-toggle="tab" href="#mains" role="tab" aria-controls="mains" aria-selected="true">Mains</a>
    <a class="nav-link" id="lunchTab" data-bs-toggle="tab" href="#lunch" role="tab" aria-controls="lunch">Lunch</a>
    <a class="nav-link" id="dinnerTab" data-bs-toggle="tab" href="#dinner" role="tab" aria-controls="dinner">Dinner</a>
    <a class="nav-link" id="drinksTab" data-bs-toggle="tab" href="#drinks" role="tab" aria-controls="drinks">Drinks</a>
</div>
<div class="row">
...
<div class="container my-5">
  <div class="row justify-content-center">
    <div class="col-12 col-8 col-lg-6 text-center">
      <h2 class="mt-5 mb-2">Make Online Reservation</h2>
      <p class="mb-6">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure, quo. Vel ea animi iste sed. Eveniet natus nisi fugiat modi totam illum ipsum quis.</p>
    </div>
  </div>
        ...
        <div class="row gx-3">
          <div class="col-md-6">
            ...
            <label class="visually-hidden" for="user_phone">Phone Number</label>
              <input type="tel" class="form-control" name="user_phone" placeholder="Phone Number">
            </div>
            <!-- EMAIL ADDRESS -->
            <div class="mb-3">
          ...
          <div class="col text-center">
              <button class="btn buttonPesan border" type="submit">Reserve a Table</button>
          </div>
        </div>
      </form>
    </div>
